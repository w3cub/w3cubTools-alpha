...
var doImages = function doImages() {
  ...
  for (var i = 0, len = images.length; i < len; i++) {
    if (/^(https?\:)?\/\//.test(images[i].src)) {
      toDataUrl('https://helloacm.com/api/image-to-base64/?url=' + images[i].src, function (url) {
        images[i].src = url;
      });
    } // getDataUri(images[i].src, (url)=> {
    //     images[i].src = url;
    // });
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  return react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement("div", {
    ...
    onChange: function onChange(event, editor) {
      var data = editor.getData(); // setTimeout(()=> {
      //     doImages();
      // }, 300)
...
//# sourceMappingURL=long-weibo.js.bf71a2feb230a180da08.hot-update.js.map