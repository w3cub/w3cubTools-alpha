  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(ImagePreviewUpload, [{
    ...
    value: function previewImage(file) {
      ...
      if (!Object(_tools_imageCommon__WEBPACK_IMPORTED_MODULE_9__["checkImageType"])(file.type)) {
        evergreen_ui__WEBPACK_IMPORTED_MODULE_10__["toaster"].alert('Files in this format are not supported');
        return;
      }
    ...
    value: function scaleImageContainer(image) {
      ...
      if (!targetWidth) {
        ...
        evergreen_ui__WEBPACK_IMPORTED_MODULE_10__["toaster"].alert('More than the container size! Please re-enter the image width');
        return;
      }
...
//# sourceMappingURL=image-to-text.js.27b743051b34633b512b.hot-update.js.map