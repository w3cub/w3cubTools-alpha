...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_3__["useEffect"])(function () {
    ...
    draw(time);
    Object(_utils_utils__WEBPACK_IMPORTED_MODULE_7__["converttoNoTone"])(transPinyin(_char));
  }, [_char]);
  Object(react__WEBPACK_IMPORTED_MODULE_3__["useEffect"])(function () {
...
var converttoNoTone = function converttoNoTone(s) {
  ...
  h.forEach(function (it) {
    s = s.replace(new RegExp('([a-z]*)?([' + it[0] + '])([a-z]*)?', 'g'), function (a, s1, s2, s3) {
      return (s1 || '') + (s3 || '') + it[1];
    });
  });
  return s;
...
//# sourceMappingURL=write-chinese.js.40dbfb1270557a8301c4.hot-update.js.map