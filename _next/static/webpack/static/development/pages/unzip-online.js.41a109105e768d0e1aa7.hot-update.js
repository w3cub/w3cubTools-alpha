...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  var saveImageTo = function saveImageTo() {
    ...
    var time = Object(_utils_utils__WEBPACK_IMPORTED_MODULE_9__["getDate"])();
    proList.push(new _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_1___default.a(function (resolve) {
      zip.file("readme.md", "Thinks using " + window.location.href + "\n\nGenerate at ".concat(time));
      resolve();
    }));

    _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_1___default.a.all(proList).then(function () {
      zip.generateAsync({
        type: "blob"
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_5__["useEffect"])(function () {
    jszip__WEBPACK_IMPORTED_MODULE_7___default.a.loadAsync(acceptedFiles[0]) // 1) read the Blob
    .then(function (zip) {
      console.info(zip.files); // setAccFiles(uniqBy([...accFiles, ...acceptedFiles], "name"));
    });
  }, [acceptedFiles]);
