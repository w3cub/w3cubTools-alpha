...
var doImages = function doImages() {
  ...
  [].slice.call(images).forEach(function (item, i) {
    if (/^(https?\:)?\/\//.test(item.src)) {
      toDataUrl('https://helloacm.com/api/image-to-base64/?url=' + item.src, function (url) {
        item.src = url;
      });
    }
  });
...
//# sourceMappingURL=long-weibo.js.606119ab894252569aae.hot-update.js.map