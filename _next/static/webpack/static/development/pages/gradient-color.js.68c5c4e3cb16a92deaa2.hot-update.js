...
function Gradient() {
  ...
  var bgDownload = function bgDownload(event) {
    ...
    var tempGradient = ctx.createLinearGradient(points.x0, points.y0, points.x1, points.y1); // var tempGradient = ctx.createLinearGradient(0, 0, 1000, 1000);
