...
function unEscapeShuffle(str) {
  if (~str.indexOf(' // ')) {
    var strAll = _str.split(' // ');

    var _str = strAll[0].split('');

    var sortkey = strAll[1].split(',');
    _str = _str.map(function (item, index) {
      return {
        index: sortkey[index] || 0,
        value: item
      };
    }).sort(function (v1, v2) {
...
//# sourceMappingURL=shuffle-twitter.js.e487b75e3b7e180a0485.hot-update.js.map