...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  var generateImage = function generateImage() {
    var images = document.querySelector(".ck.ck-content").getElementsByTagName('img');
    [].slice.call(images).reduce(function (item, _i) {
      if (/^(https?\:)?\/\//.test(item.src)) {
        return true;
      }
    }, []);
    ...
    html2canvas(el, {
      ...
      ctx.fillText("Generate by w3cubTools", canvas.width * .7, canvas.height * 0.7);
...
//# sourceMappingURL=long-weibo.js.534bf5473dc5ae765cb3.hot-update.js.map