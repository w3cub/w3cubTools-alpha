...
(function(l) {
  ...
  o = o.MD5 = n.extend({
    ...
    _doProcessBlock: function(b, e) {
      ...
      for (
        var f = this._hash.words, c = f[0], d = f[1], k = f[2], h = f[3], a = 0;
        64 > a;
        a += 4
      )
        16 > a
          ? ((c = q(c, d, k, h, b[e + a], 7, j[a])),
            (h = q(h, c, d, k, b[e + a + 1], 12, j[a + 1])),
            (k = q(k, h, c, d, b[e + a + 2], 17, j[a + 2])),
            (d = q(d, k, h, c, b[e + a + 3], 22, j[a + 3])))
          : 32 > a
          ? ((c = g(c, d, k, h, b[e + ((a + 1) % 16)], 5, j[a])),
            (h = g(h, c, d, k, b[e + ((a + 6) % 16)], 9, j[a + 1])),
            (k = g(k, h, c, d, b[e + ((a + 11) % 16)], 14, j[a + 2])),
            (d = g(d, k, h, c, b[e + (a % 16)], 20, j[a + 3])))
          : 48 > a
          ? ((c = i(c, d, k, h, b[e + ((3 * a + 5) % 16)], 4, j[a])),
            (h = i(h, c, d, k, b[e + ((3 * a + 8) % 16)], 11, j[a + 1])),
            (k = i(k, h, c, d, b[e + ((3 * a + 11) % 16)], 16, j[a + 2])),
            (d = i(d, k, h, c, b[e + ((3 * a + 14) % 16)], 23, j[a + 3])))
          : ((c = p(c, d, k, h, b[e + ((3 * a) % 16)], 6, j[a])),
            (h = p(h, c, d, k, b[e + ((3 * a + 7) % 16)], 10, j[a + 1])),
            (k = p(k, h, c, d, b[e + ((3 * a + 14) % 16)], 15, j[a + 2])),
            (d = p(d, k, h, c, b[e + ((3 * a + 5) % 16)], 21, j[a + 3])));
      f[0] = (f[0] + c) | 0;
      f[1] = (f[1] + d) | 0;
      f[2] = (f[2] + k) | 0;
      f[3] = (f[3] + h) | 0;
...
(function() {
  ...
  l.algo.HMAC = l.lib.Base.extend({
    init: function(g, i) {
      ...
      for (
        var n = (this._oKey = i.clone()),
          r = (this._iKey = i.clone()),
          o = n.words,
          j = r.words,
          b = 0;
        b < l;
