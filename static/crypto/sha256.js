      ...
      k = (q.WordArray = j.extend({
        ...
        concat: function(a) {
          ...
          if (c % 4)
            ...
            for (b = 0; b < a; b += 4) h[(c + b) >>> 2] = d[b >>> 2];
          else h.push.apply(h, d);
          this.sigBytes += a;
          return this;
        },
        clamp: function() {
      ...
      b = (q.BufferedBlockAlgorithm = j.extend({
        ...
        _process: function(a) {
          var b = this._data,
            ...
            e = this.blockSize,
            f = c / (4 * e),
            f = a ? i.ceil(f) : i.max((f | 0) - this._minBufferSize, 0),
            a = f * e,
            c = i.min(4 * a, c);
          if (a) {
...
(function(i) {
  ...
  (function() {
    ...
    for (var b = 2, e = 0; 64 > e; )
      f(b) &&
        (8 > e && (k[e] = g(i.pow(b, 0.5))), (r[e] = g(i.pow(b, 1 / 3))), e++),
        b++;
  })();
  var m = [],
    j = (j.SHA256 = f.extend({
